      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-2">
            ...
            <h1 className="text-6xl font-black tracking-tight italic uppercase leading-none">
          ...
          <div className="flex gap-4">
            ...
            <Card className="bg-emerald-500/5 border-emerald-500/20 shadow-none">
              <CardContent className="p-6 text-center space-y-1">
                ...
                <div className="text-3xl font-black tabular-nums text-emerald-500">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Velocity Card */}
          <Card className="bg-card/30 border-white/5 backdrop-blur-2xl p-8 overflow-hidden relative">
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-white/5 text-[10px] font-black uppercase tracking-widest text-muted-foreground">
                    ...
                    <th className="px-4 py-4">Velocity</th>
                  ...
                  {results?.map((res: any, i: number) => (
                    ...
                    >
                      <td className="px-8 py-6">
                        <div className="flex items-center gap-3">
                          <div className="h-8 w-8 rounded-full bg-primary/20 border border-primary/20 flex items-center justify-center font-black text-xs text-primary uppercase">
                            {res.participant_name[0]}
                          </div>
                          <div>
                            <div className="text-sm font-black group-hover:text-primary transition-colors">
                      ...
                      <td className="px-4 py-6">
                        <Badge
                          variant="outline"
                          className={cn(
                            "uppercase text-[10px] font-black tracking-widest border-none px-0",
                            res.platform === "hyve"
                              ? "text-primary"
                              : "text-muted-foreground",
                          )}
                        >
                          {res.platform === "hyve" ? "HYVE AI" : "TRADITIONAL"}
                        </Badge>
                      </td>
                      <td className="px-4 py-6">
                        <div className="flex items-center gap-2 font-mono font-black tabular-nums text-sm">
